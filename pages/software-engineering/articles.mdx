...
|-------------|--------|-------------|
| [The Design Graph](https://jxnblk.com/blog/design-graph/) | Brent Jackson ([@jxnblk](https://x.com/jxnblk)) | Constraint-based system for organizing styles in UI design |
| [The Staff Engineer’s Path's Resource List](https://noidea.dog/staff-resources) | Tanya Reilly ([@whereistanya](http://x.com/whereistanya)) | The articles referred by staffeng |
